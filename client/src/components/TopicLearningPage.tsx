          ...
          <div className="max-w-3xl space-y-8">
            <div className="text-center py-8">
              <div className="flex items-center justify-center gap-3 mb-4">
                ...
                <span className="text-lg font-medium text-muted-foreground">Loading your learning content...</span>
              </div>
              <p className="text-sm text-muted-foreground">Breaking down the topic into first principles</p>
            </div>
            <div>
