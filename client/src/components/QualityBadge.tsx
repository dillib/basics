          ...
          >
            {isExpertVerified ? (
              ...
              <>
                ...
                <span className="text-blue-700 dark:text-blue-300">AI Crafted</span>
              </>
            )}
          </Badge>
        </PopoverTrigger>
      ...
      <div className="flex items-start gap-2">
        ...
        <div>
          <p className="font-medium text-sm">
            {isExpertVerified ? "AI Verified Content" : "AI Crafted Content"}
          </p>
          <p className="text-xs text-muted-foreground">
            {isExpertVerified 
              ? "This content has been automatically validated for accuracy." 
              : "This content was crafted by AI and reviewed for quality."}
          </p>
        </div>
      </div>
